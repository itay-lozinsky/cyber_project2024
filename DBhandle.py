...
def add_users_to_feedbacks(student_username, teacher_username):
    c1.execute(f'''INSERT INTO Feedbacks (lesson_number, student_username, teacher_username, verbal_feedback) VALUES
    (?, ?, ?, ?) ''', (1, student_username, teacher_username, "None"))
    conn1.commit()
...
def add_lesson(student_username, teacher_username):
    c1.execute(f'''INSERT INTO Feedbacks (lesson_number, student_username, teacher_username, verbal_feedback) VALUES
    (?, ?, ?, ?) ''', (how_much_lessons(student_username)+1, student_username, teacher_username, "None"))
